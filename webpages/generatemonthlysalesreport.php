...
<?php
      ...
      $sql = "SELECT orders.order_id, users.user_id, users.user_firstname, users.user_lastname, orders.order_date, 
      orders.order_grandtotal, retailer_info.retailer_name
      FROM orders
